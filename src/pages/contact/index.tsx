              ...
              <CardBody className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-[#59E2C5]/10 p-3 rounded-lg">
                    <svg className="h-6 w-6 text-[#59E2C5]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    {/* <p className="text-sm text-gray-500">Follow for updates and behind-the-scenes</p> */}
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    {/* <p className="text-sm text-gray-500">View our open source projects</p> */}
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-1">GitLab</h4>
                    <a
                ...
                {/* <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-1">Twitter</h4>
                    <a
                      href="https://twitter.com/fw_dev"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#6C7994] hover:text-[#59E2C5] transition-colors"
                    >
                    ...
                    <p className="text-sm text-gray-500">Latest updates and tech insights</p>
                  </div>
                </div> */}
              </CardBody>
            </Card>
